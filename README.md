...
--pretrained_path /data/wyb/PiSA-SR/experiments/dataset-LSDIR+FFHQ/train-pisasr/checkpoints/model_20001.pkl \
--process_size 512 \
--upscale 4 \
--input_image /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/test_LR \
--output_dir /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/A_dataset/results_pisasr_20000 \
--default
--lambda_pix 1.0 \
--lambda_sem 1.0
...
python test_pisasr_B_dyno.py --pretrained_model_path /data/checkpoints/OSEDiff/ckpt/stable-diffusion-2-1-base --pretrained_path /data/wyb/PiSA-SR/experiments/train-pisasr/checkpoints/model_43001.pkl --process_size 512 --upscale 4 --input_image /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/test_LR --output_dir /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/results_pisasr_43k_prompt --lambda_pix 1.0 --lambda_sem 1.0 --align_method adain

python test_metrics.py \
--inp_imgs /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/A_dataset/results_pisasr_20000  \
--gt_imgs /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/test_HR \
--log /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/A_dataset/results_pisasr_20000/metrics
...
python test_pisasr.py \
--pretrained_model_path /data/checkpoints/OSEDiff/ckpt/stable-diffusion-2-1-base \
--pretrained_path /data/wyb/PiSA-SR/experiments/train-pisasr/checkpoints/model_43001.pkl \
--process_size 512 \
--upscale 4 \
--input_image /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/test_LR \
--output_dir /data/wyb/PiSA-SR/preset/datasets/benchmark_realsr/results_pisasr_43000 \
--lambda_pix 1.0 \
--lambda_sem 1.5
```
...
3. Start training.
   ...
   CUDA_VISIBLE_DEVICES="0,1,2,3," accelerate launch train_pisasr.py \
    ...
    --highquality_dataset_txt_paths=/data/datasets/LSDIR/LSDIR-O_paths.txt \
    ...
    --pretrained_model_path_csd="/data/checkpoints/OSEDiff/ckpt/stable-diffusion-2-1-base" \
    --dataset_txt_paths="/data/datasets/LSDIR/actual_image_paths.txt" \
    --highquality_dataset_txt_paths="/data/datasets/LSDIR/actual_image_paths.txt" \
    --dataset_test_folder="preset/testfolder" \
    --learning_rate=5e-5 \
    --train_batch_size=4 \
    --prob=0.1 \
    ...
    --enable_xformers_memory_efficient_attention --checkpointing_steps 500 \
    --seed 123 \
    --output_dir="experiments/train-pisasr-v2" \
    --cfg_csd 7.5 \
    --timesteps1 1 \
    --lambda_lpips=1.0 \
    --lambda_l2=1.0 \
    ...
    --lora_rank_unet_sem=4 \
    --min_dm_step_ratio=0.02 \
    --max_dm_step_ratio=0.98 \
    --null_text_ratio=0.5 \
    --align_method="adain" \
    --deg_file_path="params.yml" \
    --tracker_project_name "PiSASR-v2" \
    --is_module True
    --resume_ckpt="/data/wyb/PiSA-SR/experiments/train-pisasr/checkpoints/model_43001.pkl"
### Citations
