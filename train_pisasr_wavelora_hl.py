...
'''
tmux new -s pisasr_wavelora_hl1_lr1_linear_scale1 -d "CUDA_VISIBLE_DEVICES=\"6,7\" accelerate launch \
...
--seed=123 \
--output_dir=experiments/dataset-LSDIR+FFHQ/train-pisasr-wavelora-hl-lr1_linear_scale1 \
--cfg_csd=7.5 \
--timesteps1=1 \
--lambda_lpips=2.0 \
--lambda_l2=1.0 \
...
--tracker_project_name=PiSASR-wavelora-hl_scale1 \
--mixed_precision=fp16 \
--max_train_steps=20000 \
--is_module=True \
2>&1 | tee pisasr_wavelora_hl1_lr1_linear_scale1.log"
'''
